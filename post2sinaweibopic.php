...
function postData($url, $data)      
    ...
    $url = 'https://api.weibo.com/2/statuses/upload.json';//POST指向的链接   
	$status = '测试...';
	$pic_path = 'http://pica.nipic.com/2007-07-16/20077169749585_2.jpg';
	$data = array(  
	'status' => $status, 'source'=>'app key', 'pic'=>'@'.$pic_path
      );     
		$c = new OauthUtil();
	$data_query = $c->build_http_query_multi($data);
